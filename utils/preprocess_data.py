...
def parse_args():
    ...
    # GT_IMG_1
    parser.add_argument('--origin-dir', default='D:\MPcount\MPCount-main\ori_data\ShanghaiTech\part_B',
                        help='original data directory')
    parser.add_argument('--data-dir', default=r'D:\MPcount\MPCount-main\utils\data\stb',
    ...
    parser.add_argument('--dataset', default='stb', type=str,
