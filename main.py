...
from models.models import DGModel_base, DGModel_cls,DGModel_final
...
if __name__ == '__main__':
    ...
    if args.task == 'train':
        ...
        if 'checkpoint' in task_params:
            del task_params['checkpoint']
        trainer.test(checkpoint_dir=trainer.log_dir, **task_params)
    elif args.task == 'vis':
